...
public class ModItems {
    ...
    public static void registerItems () {
        Registry.register(Registry.ITEM, Cannacraft.id( "weed_seed"), WEED_SEED);
        Registry.register(Registry.ITEM, Cannacraft.id( "weed_fruit"), WEED_FRUIT);
        Registry.register(Registry.ITEM, new Identifier(Cannacraft.MOD_ID, "seed_chest"), SEED_CHEST);
        Registry.register(Registry.ITEM, new Identifier(Cannacraft.MOD_ID, "strain_analyzer"), STRAIN_ANALYZER);
    }
}
